...
3.3.0 업데이트는 한국시간 기준 3월 1일에 애플/구글 스토어에서 다운로드 가능합니다.
...
이제 매월 2회의 시즌이 운영됩니다.
	...
	- 이전 시즌의 성적과 보유한 영웅들의 평균 레벨을 기반으로 다음 시즌의 시작 리그가 결정됩니다.
...
5. 경제
	...
	**PvP 핫 타임!**
	...
	- 12:00 ~ 13:00, 22:00 ~ 23:00 사이에 PvP에서 승리할 경우 50%의 추가 골드를 획득합니다.
	...
	**상자 및 열쇠**
	- 상자에서 얻을 수 있는 영웅의 종류가 1종 고정 추가 됩니다.
...
6. 편의성 
	...
	**덱 추천 및 자동 덱 설정**
	...
	- 초급 덱, 중급 덱, 전문가 덱을 확인할 수 있으며, 선택 버튼을 누르면 자동으로 현재 덱으로 설정됩니다.
	- 현재 구성된 덱들은 최적화가 이루어진 덱이 아닌 전략 컨셉 중심의 추천 덱들 입니다. 
